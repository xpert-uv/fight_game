...
let p1Name = prompt("Enter Player One Name") || "Player 1";
let p2Name = prompt("Enter Player Two Name") || "Player 2";
...
class Game {
  ...
  declareWinner(isOver, p1, p2) {
    ...
    let message;
    if (isOver) {
      if (p1.health <= 0) message = `${p2.name} WIN'S`;
      if (p2.health <= 0) message = `${p1.name} WIN'S`;
    }
